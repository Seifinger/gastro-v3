...
.${scope} .bp-grid{display:grid;grid-template-columns:repeat(2,1fr);grid-auto-rows:130px;gap:${tokens.spacing.xs}px;}
@media(min-width:768px){.${scope} .bp-grid{grid-template-columns:repeat(4,1fr);grid-auto-rows:110px;}}
